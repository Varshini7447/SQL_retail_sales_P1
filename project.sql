...
--query to identify remaning rows fter removing null rows
SELECT COUNT(*) AS total_sales FROM retail_sales;

--query to total identify unique customers
SELECT 
    COUNT(DISTINCT customer_id) AS unq_customers 
FROM retail_sales;

--query to total  get unique categories
SELECT 
     COUNT(DISTINCT category) AS total_categories 
FROM retail_sales;

--query to get unique categories names
